...
import deleteBooks from "../../Redux/Thunk/deleteBooks";
import fetchSingleBook from "../../Redux/Thunk/fetchSingleBook";




const BookCard = ({ book, setFetchSingleBook }) => {
  ...
  const handleUpdate = (id) =>{
    dispatch(fetchSingleBook(id, setFetchSingleBook))
  }
      ...
      <div class="flex-1 h-full pr-2 pt-2 flex flex-col">
        <div class="flex items-center justify-between">
          ...
          <div class="text-gray-500 space-x-2">
            <button onClick={()=> handleUpdate(id)} class="lws-edit">
              <svg
                fill="none"
                viewBox="0 0 24 24"
                stroke-width="1.5"
            ...
            <button onClick={()=> handleDeleteBook(id)} class="lws-delete">
              <svg
                fill="none"
                viewBox="0 0 24 24"
                stroke-width="1.5"
